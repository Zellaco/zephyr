 ...
 */
#ifndef ZEPHYR_INCLUDE_ARCH_AURIX_MM_H_
#define ZEPHYR_INCLUDE_ARCH_AURIX_MM_H_
...
#include <arch/AURIX/cortex_r/arm_mpu.h>*/
/*
...
struct k_thread;
void z_AURIX_thread_mem_domains_init(struct k_thread *thread);
void z_AURIX_swap_mem_domains(struct k_thread *thread);

#endif /* _ASMLANGUAGE */

#endif /* ZEPHYR_INCLUDE_ARCH_AURIX_MM_H_ */
